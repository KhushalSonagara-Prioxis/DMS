...
namespace DMS.Model.SpDbContext;

    public partial class DoctorManagementSpContext : DbContext
    {
        public DoctorManagementSpContext() { }
        public DoctorManagementSpContext(DbContextOptions<DoctorManagementSpContext> options)
            : base(options)
        {
        }
