...
namespace DMS.Service.RepositoryFactory;
    ...
    public static class SpRepository
    {
        ...
        public static async Task ExecuteStoreProcedureQuery(this DoctorManagementSpContext catalogDbContext, string sqlQuery, object[] param)
        {
        ...
        public static async Task<string> ExecuteStoreProcedureQueryWithSID(this DoctorManagementSpContext catalogDbContext, string sqlQuery, object[] param)
        {
        ...
        public static async Task<string> ExecuteStoreProcedure(this DoctorManagementSpContext catalogDbContext, string sqlQuery, object[] param)
        {
        ...
        public static async Task<string> ExecuteStoreProcedureWithEntitySID(this DoctorManagementSpContext catalogDbContext, string sqlQuery, object[] param)
        {
        ...
        public static async Task<Page> ExecutreStoreProcedureResult(this DoctorManagementSpContext catalogDbContext, string sqlQuery, object[] param)
        {
            Page page = new Page();
        ...
        public static async Task<Page> ExecutreStoreProcedureResultList(this DoctorManagementSpContext catalogDbContext, string sqlQuery, object[] param)
        {
            Page page = new Page();
            var response = await catalogDbContext.Set<ExecutreStoreProcedureResultList>().FromSqlRaw(sqlQuery, param).ToListAsync();
            if (response != null && response.Count > 0)
